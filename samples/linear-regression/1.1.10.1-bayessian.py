...
bayessian_reg = linear_model.BayesianRidge()

lin_reg.fit(X_train, y_train)
ridge_reg.fit(X_train, y_train)
lasso_reg.fit(X_train, y_train)
bayessian_reg.fit(X_train, y_train)


y_pred_lin = lin_reg.predict(X_test)
y_pred_ridge = ridge_reg.predict(X_test)
y_pred_lasso = lasso_reg.predict(X_test)
y_pred_bayessian = bayessian_reg.predict(X_test)
...
plt.plot(X_test, y_pred_lasso, color='green', linewidth=2, linestyle='dashed', label='Lasso Regression (alpha=0.1)')
plt.plot(X_test, y_pred_bayessian, color='orange', linewidth=2, linestyle='dashed', label='Bayessian Regression (alpha=0.1)')
